...
<div class="card" style="width: 18rem;">
<img class="card-img-top" src="images/product.png" alt="Card image cap" height="200">
<div class="card-body">
<h4 class="card-title text-primary">Manage Products</h4>

<a href="manage_books.php" class="btn btn-success" style="width:100%;">View & Manage Products</a>
</div>
</div>
<div class="card" style="width: 18rem;">
