	...
	<div class="row">
		<div class="col-sm-3">
			...
			<table class="sidebar">
				...
				<tr><td><a href="Mens wear.php">Men's Wear</a></td></tr>
				<tr><td><a href="Kids wear.php">Kid's wear</a></td></tr>
				<tr><td><a href="ladies wear.php">Women's wear</a></td></tr>
				<tr><td><a href="cosmetics.php">Cosmetics</a></td></tr>
				<tr><td><a href="footwear.php">Footwear</a></td></tr>
			</table>
		</div>
		<div class="col-sm-9">
			<span id="status"></span>
			...
			<div class="row">
				...
				<?php 
					...
					$sql = "SELECT * FROM books WHERE category = 'bs' ORDER BY book_id ASC";
			...
			<br>
			<div class="tag">Men's Wear</div>
			<div class="row">

				<?php 

					$output = '';
					$sql = "SELECT * FROM books WHERE category = 'aa' ORDER BY book_id ASC LIMIT 6";
					$result = mysqli_query($link,$sql);
				...
				?>
				<div class="more"> <a href="best_sellers.php">View more of Men's wear</a> </div>
			</div>
			<br>
			<div class="tag">Kid's Wear</div>
			<div class="row">

				<?php 

					$output = '';
					$sql = "SELECT * FROM books WHERE category = 'bm' ORDER BY book_id ASC LIMIT 6";
					$result = mysqli_query($link,$sql);
				...
				?>
				<div class="more"> <a href="best_sellers.php">View more of Kid's wear</a> </div>
			</div>
